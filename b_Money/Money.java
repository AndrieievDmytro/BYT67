...
public class Money implements Comparable<Money> {
	...
	public Money add(Money other) {
		return new Money(Math.addExact(this.amount, this.currency.valueInThisCurrency(other.amount, other.currency)) , this.currency);
	}
	...
	public Money sub(Money other) {
		return new Money(Math.subtractExact(this.amount, this.currency.valueInThisCurrency(other.amount, other.currency))  , this.currency);
	}
